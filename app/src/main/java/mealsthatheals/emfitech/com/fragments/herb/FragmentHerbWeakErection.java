 ...
 */
public class FragmentHerbWeakErection extends Fragment {

    public FragmentHerbWeakErection(){
    ...
    public View onCreateView (LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState){
        ...
        return inflater.inflate(R.layout.fragment_herb_weakerection, container, false);
    }
}
