 ...
 */
public class FragmentHerbMouthOdour extends Fragment {

    public FragmentHerbMouthOdour(){
    ...
    public View onCreateView (LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState){
        ...
        return inflater.inflate(R.layout.fragment_herb_mouthodour, container, false);
    }
}
