 ...
 */
public class FragmentHerbLooseMotion extends Fragment {

    public FragmentHerbLooseMotion(){
    ...
    public View onCreateView (LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState){
        ...
        return inflater.inflate(R.layout.fragment_herb_loosemotion, container, false);
    }
}
