 ...
 */
public class FragmentHerbAntiAgeing extends Fragment {

    public FragmentHerbAntiAgeing(){
    ...
    public View onCreateView (LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState){
        ...
        return inflater.inflate(R.layout.fragment_herb_antiageing, container, false);
    }
}
