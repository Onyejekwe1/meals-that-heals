 ...
 */
public class FragmentHerbYellowFever extends Fragment {

    public FragmentHerbYellowFever(){
    ...
    public View onCreateView (LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState){
        ...
        return inflater.inflate(R.layout.fragment_herb_yellowfever, container, false);
    }
}
