...
import mealsthatheals.emfitech.com.fragments.about.FragmentAboutTyphoid;
import mealsthatheals.emfitech.com.fragments.about.FragmentAboutWR;
import mealsthatheals.emfitech.com.fragments.cure.FragmentCureTyphoid;
import mealsthatheals.emfitech.com.fragments.cure.FragmentCureWR;
import mealsthatheals.emfitech.com.fragments.herb.FragmentHerbTyphoid;
import mealsthatheals.emfitech.com.fragments.herb.FragmentHerbWR;

/**
 * Created by IFEANYI ONYEJEKWE on 9/13/2016.
 */
public class TyphoidTab extends AppCompatActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_typhoid_tab);
    ...
    private void initialise() {
        ...
        viewPager = (ViewPager) findViewById(R.id.viewPagerTyphoid);
    ...
    private void prepareDataResource() {
        ...
        addData(new FragmentAboutTyphoid(), getString(R.string.about));
        addData(new FragmentHerbTyphoid(), getString(R.string.herb));
        addData(new FragmentCureTyphoid(), getString(R.string.cure));
    }
