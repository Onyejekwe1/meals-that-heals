...
import mealsthatheals.emfitech.com.fragments.about.FragmentAboutMouthOdour;
import mealsthatheals.emfitech.com.fragments.about.FragmentAboutWR;
import mealsthatheals.emfitech.com.fragments.cure.FragmentCureMouthOdour;
import mealsthatheals.emfitech.com.fragments.cure.FragmentCureWR;
import mealsthatheals.emfitech.com.fragments.herb.FragmentHerbMouthOdour;
import mealsthatheals.emfitech.com.fragments.herb.FragmentHerbWR;

/**
 * Created by IFEANYI ONYEJEKWE on 9/13/2016.
 */
public class MouthOdourTab extends AppCompatActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mouthodour_tab);
    ...
    private void initialise() {
        ...
        viewPager = (ViewPager) findViewById(R.id.viewPagerMO);
    ...
    private void prepareDataResource() {
        ...
        addData(new FragmentAboutMouthOdour(), getString(R.string.about));
        addData(new FragmentHerbMouthOdour(), getString(R.string.herb));
        addData(new FragmentCureMouthOdour(), getString(R.string.cure));
    }
