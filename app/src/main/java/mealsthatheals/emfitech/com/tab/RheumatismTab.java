 ...
 */
public class RheumatismTab extends AppCompatActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wr_tab);
    ...
    private void initialise() {
        ...
        viewPager = (ViewPager) findViewById(R.id.viewPagerWR);
    ...
    private void prepareDataResource() {
        ...
        addData(new FragmentAboutWR(), getString(R.string.about));
        addData(new FragmentHerbWR(), getString(R.string.herb));
        addData(new FragmentCureWR(), getString(R.string.cure));
    }
